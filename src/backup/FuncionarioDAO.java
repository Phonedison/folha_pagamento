...
// String comandoSQL = "INSERT INTO funcionario (nome, cpf, data_nascimento,
...
// CustomLogger.logSucess("Funcionário '" + funcionario.getNome() + "'
...
// public void atualizarFuncionario(Funcionario funcionario, int opcao, int
// id_funcionario) throws CpfDuplicado {
// String parteSQL;
...
// String comandoSQL = "UPDATE funcionario SET " + parteSQL + " WHERE
// id_funcionario = ?; ";
...
// @Override
// public void atualizar(Funcionario entidade, int id) {
...
// if (linhas > 0) {
// CustomLogger.logWarning("Funcionário de ID '" + id_funcionario + "'
// removido!");
// } else {
...
// } catch (Exception error) {
// throw new RuntimeException("Erro ao deleter ao usuario: " +
// error.getMessage());
// }
// }

// // SELECT
// public void selecionarFuncionario(Funcionario funcionario, int opcao, String
// condicao) {
// String comandoSQL;
...
// }
// comandoSQL = "SELECT * FROM funcionario WHERE" + parametroSQL + " " +
// condicao
...
// }
// } catch (SQLException error) {
// CustomLogger.logWarning("Erro ao Encontrar Funcionário" +
// error.getMessage());
