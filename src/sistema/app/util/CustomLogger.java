...
public class CustomLogger {
  ...
  /*
   * Transformando o método acessivel em qualquer lugar sem precisa declarar -
   * dica do CADU
   */
  ...
  public static void logConectionSucess(String message) {
    System.out.println(BG_CIANO + BOLD + " " + LocalDateTime.now() + " CONEXAO - " + message + " " + RESET + " ");
  }

  public static void logConectionError(String message) {
  ...
  public static void logFolhaSucess(String message) {
    System.out.println(CIANO + ITALIC + " " + LocalDate.now() + " " + message + " " + RESET + " ");
  }

  public static void logFuncionarioSucess(String message) {
    System.out.println(VERDE + ITALIC + " " + LocalDate.now() + " " + message + " " + RESET + " ");
  }

  public static void logFuncionarioError(String message) {
    System.out.println(VERMELHO + ITALIC + " " + LocalDate.now() + " " + message + " " + RESET + " ");
  }

  public static void logDependenteError(String message) {
    System.out.println(VERMELHO + ITALIC + " " + LocalDate.now() + " " + message + " " + RESET + " ");
  }
